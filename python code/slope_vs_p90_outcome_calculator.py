...
# -*- coding: utf-8 -*-
"""
Created on Sun Jul 19 11:24:07 2020

@author: shawnmcguire

returns a matrix (pass_matrix) for a pos or neg opinion slope pass rate with p90 on x axis 

"""
#%%

def slope_vs_p90_outcome_calculator(slope_low, slope_high):
    
    '''    
    returns a matrix (pass_matrix) for a pos or neg opinion slope pass rate     
    with p90 on x axis
    '''
